...
namespace T4Toolbox.VisualStudio
{
    ...
    internal sealed class BrowseObjectExtenderProvider : IExtenderProvider, IDisposable
    {
        ...
        public BrowseObjectExtenderProvider(IAsyncServiceProvider2 serviceProvider, ObjectExtenders objectExtenders, string extenderCategory)
        {
            ...
            providerCookie = this.objectExtenders.RegisterExtenderProvider(extenderCategory, BrowseObjectExtenderProvider.ExtenderName, this);
        }
        ...
        public void Dispose()
        {
            objectExtenders.UnregisterExtenderProvider(providerCookie);
        }
        ...
        {
            return new BrowseObjectExtender(serviceProvider, (IVsBrowseObject)extendee, site, extenderCookie);
        }
    }
}