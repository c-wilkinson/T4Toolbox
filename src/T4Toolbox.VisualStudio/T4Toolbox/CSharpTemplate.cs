...
namespace T4Toolbox
{
    ...
    public abstract class CSharpTemplate : ClrTemplate
    {
        ...
        public override string TransformText()
        {
            ...
            WriteLine("//   This file was generated by T4 code generator {0}.", Path.GetFileName(Context.Host.TemplateFile));
            WriteLine("//   Any changes made to this file manually will be lost next time the file is regenerated.");
            WriteLine("// </autogenerated>");
