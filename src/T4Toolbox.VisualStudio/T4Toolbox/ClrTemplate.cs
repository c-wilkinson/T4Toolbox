    ...
    public abstract class ClrTemplate : Template
    {
        ...
        public string DefaultNamespace
        {
            get
            {
                ...
                StringBuilder defaultNamespace = new StringBuilder(RootNamespace);
                ...
                string relativeInputFilePath = Context.GetMetadataValue("Link");
                if (string.IsNullOrEmpty(relativeInputFilePath))
                {
                    ...
                    string projectFile = Context.GetPropertyValue("MSBuildProjectFullPath");
                    relativeInputFilePath = FileMethods.GetRelativePath(projectFile, Context.InputFile);
                }
        ...
        {
            get { return Context.GetPropertyValue("RootNamespace"); }
        }
    }
}