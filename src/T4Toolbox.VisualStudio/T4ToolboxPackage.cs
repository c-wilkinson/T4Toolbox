...
namespace T4Toolbox.VisualStudio
{
    ...
    public sealed class T4ToolboxPackage : AsyncPackage, IDisposable
    {
        ...
        protected override async System.Threading.Tasks.Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            ObjectExtenders objectExtenders = (ObjectExtenders)await GetServiceAsync(typeof(ObjectExtenders));
            extenderProviders.Add(new BrowseObjectExtenderProvider(this, objectExtenders, PrjBrowseObjectCATID.prjCATIDCSharpFileBrowseObject));
            extenderProviders.Add(new BrowseObjectExtenderProvider(this, objectExtenders, PrjBrowseObjectCATID.prjCATIDVBFileBrowseObject));
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                extenderProviders.ForEach(provider => provider.Dispose());
            }
        }
    }
}
